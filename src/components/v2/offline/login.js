...
import LoginForm from "../../offline/login"
  ...
  render() {
    return (
      ...
      <section id="mu-hero">
          ...
          <LoginForm labels="off" showLoseLinks={false} submitClass="mu-primary-btn" />
				</div>
				...
				<div className="col-md-6 col-sm-6 col-sm-pull-6">
					<div className="mu-hero-left">
						...
						<Link to="/signup" className="mu-primary-btn">Je n'ai pas de compte</Link>
					...
					<div className="col-md-12">
						<div className="mu-video-review-area">
							...
							<div className="mu-heading-area">
								<h2 className="mu-heading-title">Comment utiliser son compte Koontoo Home ?</h2>
