...
exports.default = function (config, globalConfig) {
	...
	var AdminPage = function (_React$Component) {
		...
		function AdminPage(props) {
			...
			_this.handleExport = function (e) {
				e.preventDefault();
				_this.setState({ mode: "export" }, _this.openSidebar);
			};
			...
			_this._buildFiltersParams = function (state) {
				var params = {};
				Object.keys(state).forEach(function (key) {
					params = Object.assign(params, _this._buildFilter(key, state[key]));
				});
			...
			_this._buildFilter = function (key, value) {
			...
			_this._handleSaveFilters = function (filters, namedFilters, currentFilter) {
				_this.setState({ mode: "savefilters", filters: filters, namedFilters: namedFilters, currentFilter: currentFilter }, _this.openSidebar);
			};

			_this._handleFiltersSaved = function (filter) {
				_this.setState({ currentFilter: filter }, _this.closeSidebar);
			};
			...
			value: function render() {
				...
				return React.createElement(
					...
					globalConfig.subHeader ? React.createElement(globalConfig.subHeader, _extends({}, globalConfig, { config: config, globalConfig: globalConfig, location: this.props.location, onNew: this.handleNew })) : React.createElement(
						...
						!config.list.actions || config.list.actions.indexOf("new") !== -1 || config.list.actions && config.list.actions.filter(function (a) {
							...
							config.list.actions && config.list.actions.indexOf("export") !== -1 ? React.createElement(
								'a',
								{ href: '#', onClick: this.handleExport, className: 'admin-new-button' },
								React.createElement('i', { className: this.getIcon("export", "archive") }),
								' Exporter'
							) : null,
			...
			value: function getSidebarContent() {
				...
				switch (this.state.mode) {
					...
					case "delete":
						...
						break;
					case "savefilters":
						content = React.createElement(_filtersSaver2.default, {
...
var _filtersSaver = require('./admin-page/list/header/filters-saver');

var _filtersSaver2 = _interopRequireDefault(_filtersSaver);

var _export = require('./admin-page/list/export.js');
