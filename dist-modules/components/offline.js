    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          ...
          null,
          React.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: (0, _authChecker2.default)(_home2.default, true, this.props.clients) }),
          React.createElement(_reactRouterDom.Route, { exact: true, path: '/login', component: (0, _authChecker2.default)(_login2.default, true, this.props.clients) }),
          React.createElement(_reactRouterDom.Route, { exact: true, path: '/signup', component: (0, _authChecker2.default)(_signup2.default, true, this.props.clients) })
        )
      );
    }
  }]);
